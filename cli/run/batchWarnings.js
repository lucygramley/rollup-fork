...
import { URL_AVOIDING_EVAL, URL_NAME_IS_NOT_EXPORTED, URL_OUTPUT_EXPORTS, URL_OUTPUT_GLOBALS, URL_SOURCEMAP_IS_LIKELY_TO_BE_INCORRECT, URL_THIS_IS_UNDEFINED, URL_TREATING_MODULE_AS_EXTERNAL_DEPENDENCY } from '../../src/utils/urls';
import { stderr } from '../logging';
export default function batchWarnings(command) {
...
const deferredHandlers = {
    ...
    UNRESOLVED_IMPORT(warnings) {
        ...
        for (const warning of warnings) {
            getOrCreate(dependencies, relativeId(warning.exporter), getNewArray).push(relativeId(warning.id));
        }
