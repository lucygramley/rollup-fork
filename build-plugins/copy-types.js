...
function copyRollupType(fileName, inputFile = 'src/rollup/types.d.ts', rollupImportPath) {
    return {
...
export function copyBrowserTypes() {
    return copyRollupType('rollup.browser.d.ts');
}
export function copyNodeTypes() {
    return [
        copyRollupType('rollup.d.ts'),
        copyRollupType('loadConfigFile.d.ts', 'cli/run/loadConfigFileType.d.ts', '../../src/rollup/types'),
