...
export function findNonWhiteSpace(code, index) {
    NON_WHITESPACE.lastIndex = index;
    const result = NON_WHITESPACE.exec(code);
    return result.index;
}
const WHITESPACE = /\s/;
export function findLastWhiteSpaceReverse(code, start, end) {
    while (true) {
        if (start >= end) {
            return end;
        }
...
export function findFirstLineBreakOutsideComment(code) {
...
export function removeLineBreaks(code, start, end) {
    while (true) {
