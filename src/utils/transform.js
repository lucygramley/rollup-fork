...
import { augmentCodeLocation, error, logInvalidSetAssetSourceCall, logNoTransformMapOrAstWithoutCode, logPluginError } from './logs';
import { normalizeLog } from './options/options';
export default async function transform(source, module, pluginDriver, log) {
    const id = module.id;
