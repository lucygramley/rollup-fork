...
export function collapseSourcemaps(file, map, modules, bundleSourcemapChain, excludeContent, log) {
...
export function collapseSourcemap(id, originalCode, originalSourcemap, sourcemapChain, log) {
